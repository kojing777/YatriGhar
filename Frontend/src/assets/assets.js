...
export const testimonials = [
    { id: 1, name: "Aayush Magar", address: "Chitwan, Nepal", image: "https://res.cloudinary.com/dp27ua535/image/upload/v1763394665/Daura_Suruwal__A_nepali_s_pride_xpno0h.jpg", rating: 5, review: "I've used many booking platforms before, but none compare to the personalized experience and attention to detail that YatriGhar provides." },
    { id: 2, name: "Aadarsha Tamang", address: "Pokhara, Nepal", image: "https://res.cloudinary.com/dp27ua535/image/upload/v1763394665/chandragiri_2081_edyqyu.jpg", rating: 4, review: "YatriGhar exceeded my expectations. The booking process was seamless, and the hotels were absolutely top-notch. Highly recommended!" },
    { id: 3, name: "Sneha Gurung", address: "Kathmandu, Nepal", image: "https://res.cloudinary.com/dp27ua535/image/upload/v1763394665/Bodo_Actress_Pooja_Basumatary_w19fkw.jpg", rating: 5, review: "Amazing service! I always find the best luxury accommodations through YatriGhar. Their recommendations never disappoint!" }
];
